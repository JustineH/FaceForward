...
//                self.labelResults.text = "Error code \(errorObj["code"]): \(errorObj["message"])"
                ...
                if faceAnnotations != JSON.null {
                 ...
                 //   let measuredAnnotations: [String: String] = ["joyLikelihood": "joy", "sorrowLikelihood": "sorrow", "surpriseLikelihood": "surprise", "angerLikelihood": "anger"]
                    ...
                    for index in 0..<numPeopleDetected {
                        ...
                        for emotion in emotions {
                            ...
                            let percent: Int = Int(round(emotionLikelihoods * 100))
